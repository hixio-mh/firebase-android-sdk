...
public class BlockingAnalyticsEventLoggerTest {
  ...
  public void
    ...
    setupOnEventCall(
        blockingAnalyticsEventLogger, APP_EXCEPTION_EVENT_NAME, eventBundle, SHORT_TIMEOUT);
  ...
  /** Sets up an on event call to be called after the given number of milliseconds */
  private static void setupOnEventCall(
      BlockingAnalyticsEventLogger logger, String name, Bundle params, long timeout) {
